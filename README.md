...
A modern enterprise inventory and order management system built with FastAPI, PostgreSQL, React, TypeScript, Tailwind CSS, React Query, Framer Motion, and Recharts.
